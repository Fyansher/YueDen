...
## 部分快捷操作
- 双击**ESC**快速最小化所有窗口并暂停、静音、启动伪装模式，自动跳转到B站播放BV1Kq3s65EzA。
- **右键**：关闭窗口；播放列表排序；资源卡片快速修改；更换高亮、下划线；
- 筛选模式下，勾选框上左键拖动进行快速选择。

## 下载

[下载 Windows x64 独立发布包](https://github.com/Fyansher/YueDen/releases/tag/v1.0.1)。完整解压后运行根目录的 `YueDen.exe`。

本仓库为对应版本的应用源码；不包含个人资源库、账号凭据、缓存、日志、node_modules 或第三方可执行文件。

发布 ZIP SHA-256：`2cc31feb468bc2cf7df4c2c3ab24ef0de6bf63855fc2c6fc39d971395759428d`

## 1.0.1 更新

- Windows 音量会话名称及图标使用 YueDen 品牌。
- 清除缓存控件移至导出备份正上方。
- 播放器任务栏缩略图增加上一项、播放/暂停、下一项控件。
